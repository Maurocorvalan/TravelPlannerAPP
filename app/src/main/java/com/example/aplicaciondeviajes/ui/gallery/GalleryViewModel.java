...
public class GalleryViewModel extends ViewModel {
    ...
    public void obtenerViajes(Context context) {
        ...
        Log.d("GalleryViewModel", "Token guardado: " + token);
        ...
        call.enqueue(new Callback<List<Viaje>>() {
            ...
            public void onResponse(Call<List<Viaje>> call, Response<List<Viaje>> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d("GalleryViewModel", "Error: " + response.code() + " " + response.message());
                }
            }

            @Override
            public void onFailure(Call<List<Viaje>> call, Throwable t) {
                Log.e("GalleryViewModel", "Error en la solicitud", t);
            }
        });
    }
        ...
        call.enqueue(new Callback<Foto>() {
            ...
            public void onResponse(Call<Foto> call, Response<Foto> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    // Crear una copia de la lista para actualizar el MutableLiveData
                    List<Viaje> viajesActualizados = new ArrayList<>(listaViajes.getValue());
                    listaViajes.postValue(viajesActualizados);

                    Log.d("GalleryViewModel", "Foto obtenida para viaje: " + viaje.getIdViaje());
                } else {
                    Log.d("GalleryViewModel", "No se encontró foto para el viaje: " + viaje.getIdViaje());
                }
            }

            @Override
            public void onFailure(Call<Foto> call, Throwable t) {
                Log.e("GalleryViewModel", "Error al obtener foto", t);
            }
        });
    }
